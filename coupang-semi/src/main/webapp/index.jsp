<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body>
    ...
    <head>
      ...
      <title>쿠팡!</title>
      <link rel="shortcut icon" href="https://image9.coupangcdn.com/image/coupang/favicon/v2/favicon.ico" />
    </head>
    ...
    <body>
      ...
      <!-- main -->
      <main>
        <img src="https://static.coupangcdn.com/ha/cmg_paperboy/image/1702979045489/C1-PC1.jpg" alt=""
          class="main-img-active" />
        <img src="https://image10.coupangcdn.com/image/ccm/banner/22ab75b623ae1fbe7db2446870d6e256.jpg" alt="" />
        <img src="https://static.coupangcdn.com/va/cmg_paperboy/image/1702617095967/Untitled-3.jpg" alt="" />
      </main>
